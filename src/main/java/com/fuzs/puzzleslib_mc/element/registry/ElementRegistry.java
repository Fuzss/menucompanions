package com.fuzs.puzzleslib_mc.element.registry;
...
import com.fuzs.puzzleslib_mc.element.side.IServerElement;
...
public abstract class ElementRegistry {
    ...
    public static <T> Optional<T> getConfigValue(String namespace, String key, Class<T> type, String... path) {
        ...
        MenuCompanions.LOGGER.error("Unable to get config value: " + "Invalid element location");
